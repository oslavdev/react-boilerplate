...
echo ; echo "-- Stoping scripts  ${USER}@${HOSTNAME}:/xuver/xuver.deployment/"
arguments_main=( "$@" )

cmd="bash /xuver/xuver.deployment/deploydown.sh -v ${arguments_main[*]} || true"; echo ; echo " >>> $cmd"; eval "$cmd";
